                ...
                if(opcaoMenu.equals("1") || opcaoMenu.equals("2") || opcaoMenu.equals("3")){
                    ...
                    switch(opcaoMenu){
                        case "1":
                            ...
                            gerentes.add(gerenteLoja);

                            System.out.println("Digite 1 para cadastrar outro Gerente; 2 para listar os Gerentes; 3 para Encerrar");
                            ...
                            if(opcaoSubMenu.equals("1") || opcaoSubMenu.equals("2") || opcaoSubMenu.equals("3")){
                                switch(opcaoSubMenu){
                                    ...
                                    case "2":
                                        for(Gerente gerenteLojaItem : gerentes){
